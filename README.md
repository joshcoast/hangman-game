...
In this assignment, you'll create a Hangman game. This apps will run in the browser, and feature dynamically updated HTML and CSS powered by your JavaScript code.
